 ...
 */
  try {
    __pyx_t_1 = get_move_from_id(48);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_v_4main_x = __pyx_t_1;
 ...
 * print(x.ptype)             # <<<<<<<<<<<<<<
 */
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_4main_x.ptype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
