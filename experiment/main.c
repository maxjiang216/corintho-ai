...
static struct Bar *__pyx_v_4main_bar;
 ...
 * print(do_bar(bar, 1))             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(do_bar(__pyx_v_4main_bar, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
